...
public class Action implements Serializable {
    ...
    public void setParams(java.util.List<com.fgnb.model.action.Param> params) {
        this.params = params;
    }

    public java.util.List<com.fgnb.model.action.LocalVar> getLocalVars() {
        return localVars;
    }

    public void setLocalVars(java.util.List<com.fgnb.model.action.LocalVar> localVars) {
        this.localVars = localVars;
    }

    public java.util.List<com.fgnb.model.action.Step> getSteps() {
        return steps;
    }

    public void setSteps(java.util.List<com.fgnb.model.action.Step> steps) {
        this.steps = steps;
    }
